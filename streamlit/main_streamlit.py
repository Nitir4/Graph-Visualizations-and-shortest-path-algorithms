...
def main():
    ...
    if 'G' in locals():  # Ensure graph is generated before proceeding
        ...
        # Compare algorithms and show results
        ...
        st.error("Please generate a graph first!")
